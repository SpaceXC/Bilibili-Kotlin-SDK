...
object BangumiInfo {
    ...
    suspend fun getBangumiTimeline(
        daysBeforeToday: Int = 6,
        daysAfterToday: Int = 6
    ): NetworkResponse<BangumiTimeline> {
        return KtorNetworkUtils.get("https://api.bilibili.com/pgc/web/timeline?types=1&before=$daysBeforeToday&after=$daysAfterToday")
    }
}